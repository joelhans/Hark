...
(function() {
  var $, History, State, ajaxHelpers, listenHeight, momentize, player, sidebarHeight, siteUrl, wookmark;
  ...
  $(function() {
    return player = new MediaElementPlayer('#player');
  });

  $('.podcastListen').click(function(e, player) {
    console.log(player);
    e.preventDefault();
    player.setSrc($(e.currentTarget).attr("data-file"));
    player.load();
    console.log('updated source: %o', player);
    player.play();
