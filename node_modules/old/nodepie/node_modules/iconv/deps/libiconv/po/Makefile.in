...
# ${SHELL} /home/panopticoff/Dropbox/web/nodejs/podekeeper/node_modules/nodepie/node_modules/iconv/deps/libiconv/build-aux/install-sh does not start with $(SHELL), so we add it.
# In automake >= 1.10, /bin/mkdir -p is derived from ${MKDIR_P}, which is defined
# either as "/path/to/mkdir -p" or ".../install-sh -c -d". For these automake
# versions, $(mkinstalldirs) and $(install_sh) are unused.
mkinstalldirs = $(SHELL) ${SHELL} /home/panopticoff/Dropbox/web/nodejs/podekeeper/node_modules/nodepie/node_modules/iconv/deps/libiconv/build-aux/install-sh -d
install_sh = $(SHELL) ${SHELL} /home/panopticoff/Dropbox/web/nodejs/podekeeper/node_modules/nodepie/node_modules/iconv/deps/libiconv/build-aux/install-sh
MKDIR_P = /bin/mkdir -p
mkdir_p = /bin/mkdir -p
